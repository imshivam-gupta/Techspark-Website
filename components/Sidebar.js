    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5">
        ...
        <Link href="/" className='flex flex-row'>
          <img src="/logosvg.png" alt="Logo" className='w-10 h-10' />
          <div className='text-white text-3xl my-auto ml-5 font-sans'>Techspark</div>
        </Link>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <LinkwithoutIcon name={"Techspark Orders"} link={"/admin/orders"} />
                          <LinkwithoutIcon name={"Registered Users"} link={"/admin/users"} />
                          <LinkwithoutIcon name={"Listed Products"} link={"/admin/products"} />
                        </ul>
                      </div>
                      {/* <!-- Dropdown Menu End --> */}
                    </React.Fragment>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <LinkwithoutIcon name={"Form Elemnets"} link={"/admin/orders"}/>
                          <LinkwithoutIcon name={"Form Layouts"} link={"/admin/orders"}/>
                        </ul>
                      </div>
                    </React.Fragment>
                  );
